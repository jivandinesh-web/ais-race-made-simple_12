...
export const RunningMan = ({ className = "fill-white", size = "48px" }: { className?: string, size?: string }) => (
  <div className="flex items-center justify-center" style={{ width: size, height: size }}>
    <svg viewBox="0 0 24 24" className={`${className} animate-run`} style={{ width: '100%', height: '100%' }}>
    ...
    <header className="sticky top-0 z-50 shadow-md gradient-charcoal-orange transition-colors" style={{ height: '20mm' }}>
      <div className="container mx-auto px-4 h-full flex items-center justify-between">
        <Link to="/" className="flex items-center h-full group">
          {/* Running Man Icon BEFORE the text */}
          <div className="flex items-center justify-center">
            <RunningMan className="fill-white" size="18mm" />
          </div>
          ...
          {/* Running Man Icon AFTER the text */}
          <div className="flex items-center justify-center">
            <RunningMan className="fill-white" size="18mm" />
          </div>
        </Link>
